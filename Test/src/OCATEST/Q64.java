...
public class Q64{
   public static void main(String[] args){  new Q64().sayHello1(); }   //1
...
//Runtime Error.
//
//You cannot have two methods with the same signature (name and parameter types)
//in one class. Also, even if you put one sayHello() method 
//in other class which is a subclass of this class, 
//it won't compile because you cannot override/hide 
//a static method with a non static method and vice versa.